...
>(({ className, accentColor, ...props }, ref) => (
  ...
  >
    ...
    <SliderPrimitive.Thumb
      className="block h-4 w-4 rounded-full border-2 bg-surface shadow-md ring-offset-base transition-transform hover:scale-110 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent/70 focus-visible:ring-offset-2 active:scale-95 disabled:pointer-events-none"
