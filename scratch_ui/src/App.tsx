...
function drawTrajectoryChart(canvasId: string) {
  ...
  // synthetic curves: PM2.5 peaks ~T+15h then decays with a small rebound; wind stays lower & flatter
  const N = 40;
  const pm = [], wind = [];
  for(let i=0;i<N;i++){
    const x = i/(N-1);
    const peak = Math.exp(-Math.pow((x-0.22)/0.16,2)); // peak near +15h of 66h domain
...
export default function App() {
  ...
  useEffect(() => {
    ...
    const cCyan = new THREE.Color('#fafafa'); // Was cyan, now white
  ...
  return (
    <>
      <div id="canvas-wrap" ref={wrapRef}></div>
      <div ref={tooltipRef} className="particle-tooltip"></div>
      ...
      <div className="hero-pin">
        <div className="hero-stage">
          ...
          <div className="stat-row">
            <div className="stat"><div className="num">107</div><div className="lbl">PM2.5 µg/m³</div></div>
            <div className="stat"><div className="num">302</div><div className="lbl">PBL HEIGHT m</div></div>
            <div className="stat"><div className="num">0.85</div><div className="lbl">INVERSION IDX</div></div>
          </div>
      ...
      <div className="dash">
        ...
        <div className="grid">
          <div className="panel" data-p="1">
            <h3>CURRENT TELEMETRY <span>T+27H</span></h3>
            <div className="metric-row"><span>PM2.5 AVG</span><span><span className="val">107</span><span className="unit">µg/m³</span></span></div>
            <div className="metric-row"><span>PBL HEIGHT</span><span><span className="val">302</span><span className="unit">m</span></span></div>
            <div className="metric-row"><span>TEMPERATURE</span><span><span className="val">28</span><span className="unit">°C</span></span></div>
            <div className="metric-row"><span>SOLAR IRR.</span><span><span className="val">306</span><span className="unit">W/m²</span></span></div>
          </div>
          ...
          <div className="panel" data-p="3">
            ...
            <div className="note danger"><b>INVERSION TRAP</b><br/>Critical inversion detected (ISI: 0.85). Low PBL and stagnation are severely restricting ventilation.</div>
          </div>
          <div className="panel" data-p="4">
            <h3>INVERSION RISK <span>ISI &gt; 0.75</span></h3>
            <div className="metric-row"><span>DELHI-NCR-CENTRAL</span><span style={{color:'var(--danger)'}}>EMERGENCY</span></div>
            <div className="metric-row"><span>DELHI-NCR-NORTH</span><span style={{color:'var(--warn)'}}>WARNING</span></div>
          </div>
        </div>
      ...
      <div id="appView" className={appOpen ? 'open' : ''}>
        ...
        <div className="app-body">
          ...
          <div className="app-col">
            ...
            <div className="panel dash-panel" style={{ transitionDelay: '0.4s' }}>
              ...
              <div className="lineage-line"><span>SOURCE</span><b>CPCB + IMD MERGED</b></div>
              <div className="lineage-line"><span>MODEL</span><b>WRF-CHEM COUPLED V4.2</b></div>
        ...
        <div className="app-timeline">
          <div className="tl-top"><span className="now">T+27H PROJECTION</span><span>TOTAL DOMAIN: 72H</span></div>
