...
export function NCRMap({ frame }: { frame: Frame }) {
  // No theme hook here on purpose: the basemap is re-themed entirely in CSS
  // (`.dark .leaflet-tile-pane` inverts the tiles), so the component has no
  // need to re-render on a theme change.
